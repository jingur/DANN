...
def arg_parse():
    ...
    # PROBLEM 3 
    parser.add_argument('--source', type=str, default='usps',
                        help="Source dataset")
    parser.add_argument('--target', type=str, default='mnistm',
                        help="Target dataset")
    parser.add_argument('--load', type=str, default='usps',
                        help="To choose which dataset to load")
    parser.add_argument('--mode', type=str, default='train',
                        help="Options: Test or Train")


    # Problem 3/4 for testing the model
    parser.add_argument('--pred_path', type=str, default='res_p3/test_pred.csv',
                        help="Path to write the predictions")
    parser.add_argument('--resume_svhn', type=str, default='uda_target_svhn.pth',
                        help="Model source MNISTM target SVHN")
    parser.add_argument('--resume_usps', type=str, default='uda_target_usps.pth',
                        help="Model source MNISTM target SVHN")
    parser.add_argument('--resume_mnistm', type=str, default='uda_target_mnistm.pth',
                        help="Model source SVHN target MNISTM")
    # Training the improved UDA model
    parser.add_argument('--model_type', type=str, default='uda',
